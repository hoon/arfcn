...
__export(index_exports, {
  ...
  NrBands: () => NrBands,
  UtraFddBands: () => UtraFddBands,
  UtraTddBands: () => UtraTddBands,
  ...
  frequencyToUarfcnFdd: () => frequencyToUarfcnFdd,
  frequencyToUarfcnTdd: () => frequencyToUarfcnTdd,
  nrArfcnToBands: () => nrArfcnToBands,
  nrArfcnToFrequency: () => nrArfcnToFrequency,
  uarfcnToBands: () => uarfcnToBands,
  uarfcnToFrequencyFdd: () => uarfcnToFrequencyFdd,
  uarfcnToFrequencyTdd: () => uarfcnToFrequencyTdd
});
